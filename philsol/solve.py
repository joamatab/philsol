"""Handles the eigen solving.
Nothing too complicated here at the moment
it just uses standard library scipy sparse libary.
We hope to add some more fancy eigen solving tricks later (e.g SLEPc)
"""
...
def solve_fancy(P, beta_trial, E_trial=None, neigs=1):
    ...
    fancy_P = PETSc.Mat().createAIJ(size=P.shape, csr=(P.indptr, P.indices, P.data))
